...
module.exports = {
  ...
  }, //  Material UI
  {
    ...
    options: {
      ...
      path: "".concat(__dirname, "/src/intl"),
      // supported language
      languages: ["cn", "en"],
      // language file path
      defaultLanguage: "cn",
    ...
    options: {
      "pure": true // Add any options here

    }
  }, {
    resolve: "gatsby-plugin-categories",
    options: {
      templatePath: "".concat(__dirname, "/src/pages/category.tsx")
    }
  }, {
    resolve: "gatsby-plugin-tags",
    options: {
      templatePath: "".concat(__dirname, "/src/pages/tag.tsx")
    }
